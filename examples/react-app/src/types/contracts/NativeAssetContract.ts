...
export type NativeAssetContractConfigurables = Partial<{
...
export class NativeAssetContractInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class NativeAssetContract extends __Contract {
  ...
  declare interface: NativeAssetContractInterface;
  declare functions: {
